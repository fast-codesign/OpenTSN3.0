...
#define INIT_S 0x00000000 //初始状态
#define BASIC_CFG_S 0x00000001 //基础配置状态
#define LOCAL_PLAN_CFG_S 0x00000002 //本地规划状态
#define REMOTE_PLAN_CFG_S 0x00000003 //远程规划配置状态
#define CONF_VERIFY_S 0x00000004 //配置验证状态
#define SYNC_INIT_S 0x00000005 //时间同步初始化状态
#define NW_RUNNING_S 0x00000006 //网络运行状态
