#custom ip
Custom 14 IP cores used in the project in Inter Quartus  and  put qsys file and IP core folder generated in current directory; information of those IP cores is as follow.
number_1 ip core : 
...
number_10 ip core:RAM
    Ip_core_name: sdprf16x23_s
    Operation Mode:With one read port and one write port
    Ram_width:23
    Ram_depth:16
    Clocking method : Single
...
number_11 ip core:RAM
    Ip_core_name: sdprf16x57_s
    Operation Mode:With one read port and one write port
    Ram_width:57
    Ram_depth:16
    Clocking method : Single
