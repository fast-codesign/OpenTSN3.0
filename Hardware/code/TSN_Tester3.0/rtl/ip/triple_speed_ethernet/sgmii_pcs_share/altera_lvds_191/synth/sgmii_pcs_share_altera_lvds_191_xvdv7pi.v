// sgmii_pcs_share_altera_lvds_191_xvdv7pi.v
...
`timescale 1 ps / 1 ps
module sgmii_pcs_share_altera_lvds_191_xvdv7pi (
		input  wire [3:0]  rx_in,         //         rx_in.export
		output wire [39:0] rx_out,        //        rx_out.export
		output wire        rx_coreclock,  //  rx_coreclock.export
		input  wire        inclock,       //       inclock.export
		input  wire        pll_areset,    //    pll_areset.export
		output wire [3:0]  rx_dpa_locked, // rx_dpa_locked.export
		input  wire [3:0]  rx_dpa_reset,  //  rx_dpa_reset.export
		output wire [3:0]  rx_divfwdclk,  //  rx_divfwdclk.export
		output wire        pll_locked     //    pll_locked.export
	);

	sgmii_pcs_share_altera_lvds_core20_191_hbfz3py #(
		.NUM_CHANNELS                       (4),
		.J_FACTOR                           (10),
		...
		.rx_coreclock            (rx_coreclock),                                 //  rx_coreclock_conduit_end.export
		.inclock                 (inclock),                                      //       inclock_conduit_end.export
		.pll_areset              (pll_areset),                                   //    pll_areset_conduit_end.export
		.rx_dpa_locked           (rx_dpa_locked),                                // rx_dpa_locked_conduit_end.export
		.rx_dpa_reset            (rx_dpa_reset),                                 //  rx_dpa_reset_conduit_end.export
		.rx_divfwdclk            (rx_divfwdclk),                                 //  rx_divfwdclk_conduit_end.export
		.pll_locked              (pll_locked),                                   //    pll_locked_conduit_end.export
		.tx_in                   (40'b0000000000000000000000000000000000000000), //               (terminated)
		.tx_out                  (),                                             //               (terminated)
